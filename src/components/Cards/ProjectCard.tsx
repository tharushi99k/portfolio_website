...
const ProjectCard: React.FC<Props> = ({ image, title, description, tech1, tech2, tech3, tech4 }) => {
  return (
    <div className="grid w-[90%] mx-auto  grid-cols-1 lg:grid-cols-2 gap-10 items-center">
      ...
      <div>
        ...
        <div className="mt-[1.3rem] w-full  text-sm items-center justify-center grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-[1rem]">
